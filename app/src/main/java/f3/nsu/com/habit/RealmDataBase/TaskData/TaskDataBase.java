...
public class TaskDataBase extends RealmObject {
    ...
    @Required
    private ArrayList<TaskList> taskDataBaseList = new ArrayList<TaskList>();

    public TaskDataBase(ArrayList<TaskList> taskDataBaseList) {
    ...
    public ArrayList<TaskList> getTaskDataBaseList() {
        return taskDataBaseList;
    }

    public void setTaskDataBaseList(ArrayList<TaskList> taskDataBaseList) {
        this.taskDataBaseList = taskDataBaseList;
    }
