...
public class SecondPushClass {
    ...
    public List<TaskList> showMySecondPush() {
        secondPushList.add(new TaskList("早起",4,false,100,1,"08:00",26));
        secondPushList.add(new TaskList("早上空腹喝杯水",5,false,100,2,"08:10",6));
        secondPushList.add(new TaskList("坚持午觉",6,false,100,4,"13:00",11));
        secondPushList.add(new TaskList("每天运动半小时",5,false,100,5,"18:00",27));
        secondPushList.add(new TaskList("睡前不玩手机",4,false,100,3,"22:00",28));
